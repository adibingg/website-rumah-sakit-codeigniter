              ...
              <tbody>
                ...
                <?php foreach($jadwal->result() as $row){ ?>
                  <tr>
                    ...
                    <td><?= $row->minggu; ?></td>
                    <td>
                      <a href="<?= base_url('admin/doctor/schedule/update/').$row->doctor_schedule_id; ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>
                      <a href="<?= base_url('admin/doctor/schedule/delete/').$row->doctor_schedule_id; ?>" class="btn btn-danger btn-xs hapus"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
