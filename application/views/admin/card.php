        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button id="save-service" type="button" class="btn btn-primary">Save</button>
                  ...
                  <div class="x_content">
                    <div class="row">
                      <?php echo form_open_multipart('admin/card_home/save_pages');?>
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="icon" class="form-control" placeholder="Pilih Icon">
                                <button type="button" class="btn btn-link btn-xs" id="icon">Pilih icon</button>
                            </div>
                            <div class="form-group">
